...
st.set_page_config(
    page_title="💖 Generador LSTM Girly 💖",
    page_icon="💅",
    layout="wide",
...
.main-title{font-size:2.3rem;font-weight:800;text-align:center;background:linear-gradient(90deg,#ff4da6,#ff99cc,#ff66b2);-webkit-background-clip:text;-webkit-text-fill-color:transparent;text-shadow:0px 0px 10px rgba(255,105,180,0.4);}
...
with st.sidebar:
    ...
    selected_seed = st.selectbox("✨ Elige:", ["(personalizada)"] + seeds)

    st.markdown("---")
    st.markdown("""<div class="info-box">
    💖 Modelo LSTM entrenado con el <b>Quijote</b>.
